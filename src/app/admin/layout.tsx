  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-8">
      <div className="mb-8 flex flex-wrap gap-2">
        ...
        <Link href="/admin/etiquetas" className="rounded-full border border-bege-claro bg-white px-5 py-2 text-xs text-verde-principal hover:bg-verde-principal hover:text-white">Etiquetas</Link>
        ...
        <Link href="/admin/atividades" className="rounded-full border border-bege-claro bg-white px-5 py-2 text-xs text-verde-principal hover:bg-verde-principal hover:text-white">Atividades</Link>
      </div>
      {children}
    </div>
  );
